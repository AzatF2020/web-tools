          ...
          displayName: (a) => {
            ...
            return a.type.displayName
              ...
              : Xr(a.type, 'displayName')
                ? Xr(a.type, 'displayName')
                : (h = a.type.render) != null && h.displayName
...
`,
  ...
  bo = (e) => {
    ...
    return (t == null ? void 0 : t.type) === $r.DYNAMIC
      ? !1
      : !r || (t == null ? void 0 : t.code) || (t == null ? void 0 : t.type) === $r.CODE;
  },
  So = (e) => {
    var t, r;
    return (
  ...
  Mn = (e, t) => {
    ...
    let s = e();
    if (i) return s;
    let a = { ...vo, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      h =
